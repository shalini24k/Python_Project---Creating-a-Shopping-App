...
# Class ECommerceApp to perform operations on Demo Marketplace
class ECommerceApp:
    def __init__(self):
    ...
    def display_cart_menu(self, user):
        while True:
            ...
            if option == item + 2:  # Remove Items from CART
                print("Enter the Item in the menu to be Removed :")
                del_item = int(input())
                if del_item < item + 1:
    ...
    def display_catalog(self, user, option):
        while True:
            ...
            if option == 1 or option == 0 or option == -1:
                ...
                if option != 0 and option != -1:  # don't need EXIT menu for Admin Catalog and User initial Catalog
                    print("\t {}.".format(i + 1), " EXIT (Back to Previous Menu)")
                print("\n\n")
                if option == 0 or option == -1:  # Exit the method
                    ...
                    elif display_option == i + 1:  # Back to Previous Menu
                        return 9999
                    else:
                        print("OUT OF MENU RANGE")
                        return i + 1
